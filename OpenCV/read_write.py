...
# ảnh màu OpenCV tổ chức dữ liệu theo Height, Width, Channel (HWC)
# Channel được sắp xếp theo thứ tự Blue, Green, Red (BGR)
...
# plt.imshow(img)
# NOTE: matplotlib hiển thị sai màu do cv2 đọc ảnh màu theo thứ tự BGR
